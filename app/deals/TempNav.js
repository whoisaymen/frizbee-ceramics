...
const TempNav = () => {
    ...
    return (
        <>
        <div className="fixed top-0 left-2 sm:left-12 right-0 z-10 font-light tracking-tight uppercase mx-auto mt-4 list-none flex items-center justify-center h-[10vh]">
            ...
            <Link
                href="/"
                className="absolute z-[500] top-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -rotate-6 custom-cursor mt-2"
            >

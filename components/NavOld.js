...
export default function Nav() {
  ...
  return (
    <div
      className="font-light tracking-tight uppercase fixed top-0 left-0 right-0 mx-auto z-50 lg:mt-4"
      id="header"
    >
      <div className="md:fixed bottom-0 left-0 right-0 z-50">
        <MarketingBanner />
      </div>
          ...
          <nav aria-label="Top" className="mx-auto">
            <div className="w-full flex items-start justify-between">
              <div className="hidden lg:flex">
                {Object.keys(submenus).map((category) => (
                  ...
                  >
                    ...
                    <div
                      className={`cursor-pointer px-4 custom-cursor  bg-[#fff]/90 border-black border hover:bg-black hover:text-white italic transition duration-200 ease-out ${
              ...
              >
                <div className="-rotate-3 self-center">
                  ...
                  >
                    ...
                    <div className="h-[5.7rem] w-auto max-w-[200px] mx-auto z-50 p-3 pb-5">
                      <Image
                        src="/images/logo.png"
                        height={1000}
                        width={1000}
                ...
                <div className="z-10 fixed bottom-10 right-0">
                  <div className="lg:hidden">
                    <div className="flex items-start justify-end">
                      <div
                        className={`flex flex-col border items-center border-black ml-4 ${
                          cartQuantity > 0 ? "bg-[#EADF50]" : "bg-white/95"
                        }`}
                ...
                {/* <div className="w-full flex justify-center">
                  {["color", "shape", "pattern", "new", "set"].map((option) => (
                    <span
                      key={option}
                      className={` py-[4px] font-light bg-white -ml-[1px] ${
                        sortOption === option
                          ? "bg-[#000] text-white"
                          : "text-black"
                      }`}
              ...
              <Link
                href="/"
                onClick={() => setSortOption("")}
                className=" lg:absolute lg:top-6 lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2 -rotate-6 custom-cursor lg:z-[2000]"
              >
                <span className="sr-only">Frizbee Ceramics</span>
                <div className="h-14 lg:h-[5.4rem] w-auto -mb-6 mt-6">
                  {" "}
                  {/* Container with size */}
                  <Image
                    src="/images/logo.png"
              ...
              >
                ...
                >
                  <Image
                    ...
                    height={140}
                    width={140}
                    className="h-20 w-auto -mb-6 mt-6 object-contain"
                    alt="Frizbee Ceramics logo"
                    priority
                    style={{
                      maxWidth: "100%",
                ...
                <div className="hidden lg:block">
                  <div className="flex items-start justify-end">
                    ...
                    <div className="hover:-rotate-3">
                      <Link
                        href="/about"
                        className={`px-4 py-[2px] ml-4 border border-black bg-black text-white first-letter:${
                          pathname === "/about" ? "bg-[#F3FFE0]" : "bg-black"
                        } `}
                      >
                        <span>About</span>
                      </Link>
